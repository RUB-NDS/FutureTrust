 ...
 * element interface generated in the oasis.names.tc.saml._1_0.assertion
 * package.
 * <p>
...
public class ObjectFactory {
    ...
    private final static QName _AuthenticationStatement_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "AuthenticationStatement");
    private final static QName _NameIdentifier_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "NameIdentifier");
    ...
    private final static QName _AuthorityBinding_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "AuthorityBinding");
    private final static QName _Evidence_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Evidence");
    private final static QName _AudienceRestrictionCondition_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "AudienceRestrictionCondition");
    private final static QName _DoNotCacheCondition_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "DoNotCacheCondition");
    private final static QName _AttributeDesignator_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "AttributeDesignator");
    ...
    private final static QName _AssertionIDReference_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "AssertionIDReference");
    private final static QName _SubjectStatement_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "SubjectStatement");
    private final static QName _SubjectConfirmationData_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "SubjectConfirmationData");
    private final static QName _Conditions_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Conditions");
    private final static QName _SubjectLocality_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "SubjectLocality");
    private final static QName _ConfirmationMethod_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "ConfirmationMethod");
    private final static QName _AttributeValue_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "AttributeValue");
    private final static QName _AuthorizationDecisionStatement_QNAME = new QName(
    ...
    private final static QName _AttributeStatement_QNAME = new QName("urn:oasis:names:tc:SAML:1.0:assertion",
            "AttributeStatement");

    /**
     * Create a new ObjectFactory that can be used to create new instances of
     * schema derived classes for package: oasis.names.tc.saml._1_0.assertion
     * 
     */
     ...
     * {@link AuthenticationStatementType }{@code >}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}
     * {@link AuthorityBindingType }{@code >}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}
     * {@link AudienceRestrictionConditionType }{@code >}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}
     * {@link DoNotCacheConditionType }{@code >}
     * 
     */
    ...
    public JAXBElement<DoNotCacheConditionType> createDoNotCacheCondition(DoNotCacheConditionType value) {
        return new JAXBElement<DoNotCacheConditionType>(_DoNotCacheCondition_QNAME, DoNotCacheConditionType.class,
                null, value);
    }
    ...
    public JAXBElement<AttributeDesignatorType> createAttributeDesignator(AttributeDesignatorType value) {
        return new JAXBElement<AttributeDesignatorType>(_AttributeDesignator_QNAME, AttributeDesignatorType.class,
                null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}
     * {@link SubjectStatementAbstractType }{@code >}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}
     * {@link AuthorizationDecisionStatementType }{@code >}
     * 
     */
    ...
    public JAXBElement<AuthorizationDecisionStatementType> createAuthorizationDecisionStatement(
        ...
        return new JAXBElement<AuthorizationDecisionStatementType>(_AuthorizationDecisionStatement_QNAME,
                AuthorizationDecisionStatementType.class, null, value);
    }
    ...
    public JAXBElement<SubjectConfirmationType> createSubjectConfirmation(SubjectConfirmationType value) {
        return new JAXBElement<SubjectConfirmationType>(_SubjectConfirmation_QNAME, SubjectConfirmationType.class,
                null, value);
    }
    ...
    public JAXBElement<AttributeStatementType> createAttributeStatement(AttributeStatementType value) {
        return new JAXBElement<AttributeStatementType>(_AttributeStatement_QNAME, AttributeStatementType.class, null,
                value);
    }
